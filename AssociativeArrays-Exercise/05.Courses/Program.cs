    ...
    internal class Program
    {
        static void Main()
        {
            ...
            while ((command = Console.ReadLine()) != "end")
            {
                ...
                if (!coursesInfo.ContainsKey(courseName)) //Checcking if courseInfo does not contain coursName
                {
                    coursesInfo[courseName] = new List<string>(); //Instatiating the Value
                }
                //Making sure that we already have created instance for the value
