...
namespace _05.TeamworkProjects
{
            ...
            while ((command = Console.ReadLine()) != "end of assignment")
            {
                ...
                else
                {
                    Team teamToJoin = teams
                        .First(t => t.Name == teamName); //Returns the first instance/object where the Team name == searched team
    ...
    public class Team
    {
        ...
        //Get only property
        public List<string> Members => members; // always returns  the value of the associated field
